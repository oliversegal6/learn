...
ssh-keygen -t rsa -C "oliversegal@163.com" 

cat /home/oliver/.ssh/id_rsa.pub
...
```shell
$ git config --global user.name  "oliver"//你的GitHub登陆名
$ git config --global user.email "oliversegal@163.com"//你的GitHub注册邮箱
```
...
## git clone
    ...
    git clone git@github.com:oliversegal6/CloudCore.git
